...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MODEPAIEMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_MODEPAIEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MODEPAIEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MODEPAIEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MODEPAIEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MODEPAIEMENT actions', async () => {
      const expectedActions = [
        {
