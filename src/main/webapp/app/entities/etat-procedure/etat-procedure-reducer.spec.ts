...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ETATPROCEDURE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ETATPROCEDURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ETATPROCEDURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ETATPROCEDURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ETATPROCEDURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ETATPROCEDURE actions', async () => {
      const expectedActions = [
        {
