...
import reducer, { getEntities, getEntity, reset } from './acces.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { IAcces, defaultValue } from 'app/shared/model/acces.model';
...
describe('Entities reducer tests', () => {
  ...
  const initialState: EntityState<IAcces> = {
    loading: false,
    errorMessage: null,
    entities: [],
    entity: defaultValue,
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACCES_LIST actions', async () => {
    ...
    it('dispatches FETCH_ACCES actions', async () => {
      const expectedActions = [
        {
