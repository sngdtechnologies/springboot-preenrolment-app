...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TYPEPASSPORT_LIST actions', async () => {
    ...
    it('dispatches FETCH_TYPEPASSPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TYPEPASSPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TYPEPASSPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TYPEPASSPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TYPEPASSPORT actions', async () => {
      const expectedActions = [
        {
