...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './passport.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PASSPORT_LIST actions', async () => {
    ...
    it('dispatches FETCH_PASSPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PASSPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PASSPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PASSPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PASSPORT actions', async () => {
      const expectedActions = [
        {
