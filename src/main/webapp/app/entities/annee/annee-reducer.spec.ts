...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './annee.reducer';
import { EntityState } from '../../shared/reducers/reducer.utils';
import { IAnnee, defaultValue } from '../../shared/model/annee.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ANNEE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ANNEE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ANNEE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ANNEE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ANNEE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ANNEE actions', async () => {
      const expectedActions = [
        {
