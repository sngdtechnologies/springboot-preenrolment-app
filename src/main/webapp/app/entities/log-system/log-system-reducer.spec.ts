...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOGSYSTEM_LIST actions', async () => {
    ...
    it('dispatches FETCH_LOGSYSTEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LOGSYSTEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LOGSYSTEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LOGSYSTEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LOGSYSTEM actions', async () => {
      const expectedActions = [
        {
